import { hasInjectionContext, inject, version, unref, ref, defineComponent, useSlots, h, Fragment, computed, provide, shallowReactive, watch, Suspense, nextTick, Transition, getCurrentInstance, reactive, toRaw, mergeProps, useSSRContext, createApp, effectScope, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toValue as toValue$1, onScopeDispose } from 'vue';
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as sanitizeStatusCode, p as createHooks, h as createError$1, t as toRouteMatcher, q as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-DOraSrAK.mjs')
  }
];
...
const generalAnchorScroll = ({ hash }) => {
  ...
  const scrollVariants = {
    toTop: {
      scrollOptions: toValue$1((_a = useNuxtApp().$anchorScroll) == null ? void 0 : _a.defaults.toTop) || {}
    }
  };
  if (hash !== "") {
    try {
      ...
      scrollVariants.toAnchor = {
        target,
        scrollOptions: toValue$1((_b = useNuxtApp().$anchorScroll) == null ? void 0 : _b.defaults.toAnchor) ?? {}
      };
    } catch (error) {
...
const layouts = {
  default: () => import('./default-DCnJtkMP.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DGpMA-g0.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CfTI7WMj.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, useRoute as d, entry$1 as default, defu as e, resolveUnrefHeadInput as f, injectHead as i, nuxtLinkDefaults as n, resolveRouteObject as r, useRouter as u };
